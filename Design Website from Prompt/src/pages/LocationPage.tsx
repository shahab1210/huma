...
export default function LocationPage({ slug }: LocationPageProps) {
  ...
  return (
    <>
      <SEOHead
        title={location.seoTitle || `Mehendi Artist in ${location.name} | Huma Mehendi`}
        description={location.seoDescription || location.shortDescription || `Professional mehendi artist in ${location.name}. Book bridal mehendi, Arabic henna designs, makeup & parlour services.`}
      ...
      <section className="relative overflow-hidden bg-brand/5 px-6 py-16 text-center sm:px-12 lg:px-24">
        {location.heroImage && (
          <img
            ...
            alt={`Mehendi artist in ${location.name} - Huma Mehendi`}
        ...
        <div className="relative">
          ...
          <h1 className="mt-4 font-serif text-4xl tracking-tight text-ink sm:text-5xl">
            Mehendi Artist in {location.name}
          </h1>
